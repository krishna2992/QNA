        ...
        <nav className='main-nav'>
            <div className="navbar">
                ...
                { User === null ? 
                    ...
                    <>
                        <Avatar backgroundColor="#009dff" px="10px" py="7px" borderRadius="50%"><Link to={`/Users/${User?.result?._id}`} className='' style={{color: "white", textDecoration:"none"}}>{User.result.name.charAt(0).toUpperCase()}</Link></Avatar>
